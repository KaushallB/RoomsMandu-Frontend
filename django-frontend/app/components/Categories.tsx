...
const Categories = () => {
    ...
    const _setCategpry = (_category: string) => {
        setCategory(_category);

        const query: SearchQuery = {
            district: searchModal.query.district,
            category: _category,
    ...
    return (
        <div className="pt-3 cursor-pointer pb-6 flex items-center space-x-12">
            ...
            <div 
                onClick={() => _setCategpry('SingleRooms')}
                className="pb-4 flex flex-col items-center space-y-2 border-b-2 border-white opacity-60 hover:border-gray-200 hover:opacity-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <div 
                onClick={() => _setCategpry('Office Space')}
                className="pb-4 flex flex-col items-center space-y-2 border-b-2 border-white opacity-60 hover:border-gray-200 hover:opacity-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
            ...
            <div 
                onClick={() => _setCategpry('Warehouse')}
                className="pb-4 flex flex-col items-center space-y-2 border-b-2 border-white opacity-60 hover:border-gray-200 hover:opacity-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
